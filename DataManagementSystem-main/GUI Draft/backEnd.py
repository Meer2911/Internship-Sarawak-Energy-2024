...
class ExcelProcessor:
    ...
    def openExcelFile(self):
        excel_file_path, _ = QFileDialog.getOpenFileName(self.parent, "Select Excel File", "", "Excel files (*.xlsx)")
        if excel_file_path:
    ...
    def openVisioFile(self):
        visio_file_path = QFileDialog.getOpenFileName(self.parent, "Select Visio File", "", "Visio files (*.vsdx)")[0]
        if visio_file_path:
